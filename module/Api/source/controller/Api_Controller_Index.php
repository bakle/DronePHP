...
class Api_Controller_Index extends Drone_Mvc_AbstractionController
{
    ...
    public function getFileInfo()
    {
        ...
        {
            $exp_part = explode("_", $part);
            $parsed_part = $exp_part[count($exp_part) - 1];
            $str_file .= $parsed_part . "/";
        }
        $str_file = substr($str_file, 0, -1);

        $json_file = "data/api/" . str_replace("_", "/", $str_file) . ".json";
